                        ...
                        <div className="col-lg-8">
                            <div className="row">
                                <div className="col-lg-12">
                                    ...
                                    <div className="table-box bg-custom-white padding-20 mb-xl-20">
                                            ...
                                            <div className="contact-form">
                                                <form>
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                <textarea name="#" className="form-control form-control-custom" placeholder="Your Message" defaultValue={""} />
                                                            </div>
                                                        </div>
